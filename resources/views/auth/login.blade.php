...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .logo-mark::before { content: ""; position: absolute; inset: -18px -16px -10px; z-index: -1; border-radius: 50%; background: radial-gradient(circle at 50% 22%, rgba(255,211,38,.72) 0%, rgba(255,188,0,.34) 28%, rgba(255,188,0,.10) 52%, transparent 76%), radial-gradient(circle at 23% 64%, rgba(255,187,0,.28) 0%, transparent 48%), radial-gradient(circle at 78% 66%, rgba(57,190,76,.22) 0%, transparent 48%); filter: blur(12px); opacity: .95; transform: translateY(-2px); pointer-events: none; }
    .logo-mark::after { content: ""; position: absolute; left: 18%; right: 18%; bottom: 1px; z-index: -1; height: 10px; border-radius: 50%; background: radial-gradient(ellipse at center, rgba(255,196,0,.38) 0%, rgba(255,196,0,.14) 46%, transparent 76%); filter: blur(7px); opacity: .9; pointer-events: none; }
    .logo-mark img { width: 92px; height: 92px; object-fit: contain; border-radius: 0; background: transparent !important; filter: brightness(1.34) contrast(1.22) saturate(1.18) drop-shadow(0 0 9px rgba(255,204,0,.42)) drop-shadow(0 0 18px rgba(255,183,0,.20)) drop-shadow(0 7px 12px rgba(0,0,0,.38)); transition: transform .25s ease, filter .25s ease; }
    .logo-mark img:hover { transform: translateY(-2px) scale(1.045); filter: brightness(1.42) contrast(1.25) saturate(1.22) drop-shadow(0 0 12px rgba(255,211,38,.58)) drop-shadow(0 0 24px rgba(255,183,0,.28)) drop-shadow(0 9px 16px rgba(0,0,0,.44)); }
    .logo-text { color: #fff; }
