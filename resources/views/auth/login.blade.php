...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .logo-mark::after { content: ""; position: absolute; left: 18%; right: 18%; bottom: 1px; z-index: -1; height: 7px; border-radius: 50%; background: radial-gradient(ellipse at center, rgba(255,196,0,.22) 0%, rgba(255,196,0,.07) 46%, transparent 76%); filter: blur(5px); opacity: .55; pointer-events: none; }
