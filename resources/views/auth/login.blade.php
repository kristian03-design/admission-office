...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .logo-mark { position: relative; width: 96px; height: 96px; border-radius: 0; background: transparent; display: flex; align-items: center; justify-content: center; overflow: visible; isolation: isolate; }
    .logo-mark::before { content: ""; position: absolute; inset: -12px -10px -6px; z-index: -1; border-radius: 50%; background: radial-gradient(circle at 50% 22%, rgba(255,211,38,.36) 0%, rgba(255,188,0,.16) 28%, rgba(255,188,0,.04) 52%, transparent 76%), radial-gradient(circle at 23% 64%, rgba(255,187,0,.12) 0%, transparent 48%), radial-gradient(circle at 78% 66%, rgba(57,190,76,.08) 0%, transparent 48%); filter: blur(9px); opacity: .68; transform: translateY(-2px); pointer-events: none; }
    .logo-mark::after { content: ""; position: absolute; left: 8%; right: 8%; bottom: -5px; z-index: -1; height: 13px; border-radius: 50%; background: radial-gradient(ellipse at center, rgba(255,196,0,.32) 0%, rgba(255,196,0,.14) 36%, rgba(255,196,0,.06) 58%, transparent 78%); filter: blur(8px); opacity: .72; pointer-events: none; }
    .logo-mark img { width: 92px; height: 92px; object-fit: contain; border-radius: 0; background: transparent !important; filter: brightness(1.22) contrast(1.14) saturate(1.08) drop-shadow(0 0 5px rgba(255,204,0,.18)) drop-shadow(0 0 10px rgba(255,183,0,.08)) drop-shadow(0 5px 10px rgba(0,0,0,.34)); transition: transform .25s ease, filter .25s ease; }
    .logo-mark img:hover { transform: translateY(-2px) scale(1.045); filter: brightness(1.28) contrast(1.17) saturate(1.12) drop-shadow(0 0 7px rgba(255,211,38,.26)) drop-shadow(0 0 14px rgba(255,183,0,.12)) drop-shadow(0 7px 13px rgba(0,0,0,.40)); }
    .logo-text { color: #fff; }
