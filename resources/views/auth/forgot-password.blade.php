...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    :root { --navy: #071b3d; --navy-mid: #0b2d6b; --navy-deep: #031024; --gold: #c9933a; --gold-light: #e8b96a; --border: rgba(255,255,255,.12); --text-muted: rgba(255,255,255,.45); }
    ...
    .orb-1 { width: 500px; height: 500px; top: -100px; left: -80px; background: rgba(11,45,107,.35); }
