...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/admin-dashboard.css') }}?v=24" />
  ...
  <script src="{{ asset('js/admin-dashboard.js') }}?v=48" defer></script>
</head>
    ...
    <div class="modal-box confirm-modal-box">
      <div class="confirm-modal-content">
        <div id="confirmModalIcon" class="confirm-modal-icon">
          <i id="confirmModalIconInner" data-iconsax="trash"></i>
        </div>
        <div>
        ...
        <div class="confirm-modal-actions">
          <button type="button" class="btn-ghost confirm-modal-btn" id="confirmModalCancelBtn">Cancel</button>
          <button type="button" class="confirm-modal-btn confirm-modal-btn-danger" id="confirmModalConfirmBtn">Confirm</button>
        </div>
      </div>
    </div>
  </div>
