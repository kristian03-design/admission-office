...
<head>
  ...
  <style>
    ...
    .mb {
      ...
      transform: translateZ(0) scale(.92) translateY(24px);
    }
  ...
  <header class="hdr no-print">
    <div class="hdr-inner">
      ...
      <div class="hdr-actions">
        <a href="{{ route('home') }}" class="bs" style="font-size:12px;padding:8px 16px;border-radius:89px;background:rgba(255,255,255,0.1);border-color:rgba(255,255,255,0.2);color:white">
  ...
  <main class="main-wrap">
    ...
    <form id="aForm" novalidate>
      ...
      <div class="sc active" data-step="1">
        <div class="fcard">
          <div class="fhdr">
            <h2>Step 1: Type of Respondent</h2>
          ...
          <div class="fbdy">
            ...
            <label class="oc" style="align-items:center"><input type="radio" name="respondentType" value="Freshmen" style="width:18px;height:18px;flex-shrink:0;margin-top:2px;accent-color:var(--navy)"><div style="margin-left:14px"><div style="font-weight:700;color:#1f2937">Freshmen</div><p style="font-size:12px;color:#6b7280;margin-top:2px">High school graduate applying for the first time</p></div><button type="button" class="bs" style="margin-left:auto;padding:4px 12px;font-size:11px;border-radius:99px" onclick="showReqModal('Freshmen')">View requirements</button></label>
            <label class="oc" style="align-items:center"><input type="radio" name="respondentType" value="Transferee" style="width:18px;height:18px;flex-shrink:0;margin-top:2px;accent-color:var(--navy)"><div style="margin-left:14px"><div style="font-weight:700;color:#1f2937">Transferee</div><p style="font-size:12px;color:#6b7280;margin-top:2px">Transferring from another higher education institution</p></div><button type="button" class="bs" style="margin-left:auto;padding:4px 12px;font-size:11px;border-radius:99px" onclick="showReqModal('Transferee')">View requirements</button></label>
            <label class="oc" style="align-items:center"><input type="radio" name="respondentType" value="ALS Graduate" style="width:18px;height:18px;flex-shrink:0;margin-top:2px;accent-color:var(--navy)"><div style="margin-left:14px"><div style="font-weight:700;color:#1f2937">ALS Graduate</div><p style="font-size:12px;color:#6b7280;margin-top:2px">Alternative Learning System graduate with A&amp;E Certificate</p></div><button type="button" class="bs" style="margin-left:auto;padding:4px 12px;font-size:11px;border-radius:99px" onclick="showReqModal('ALS Graduate')">View requirements</button></label>
            <label class="oc" style="align-items:center"><input type="radio" name="respondentType" value="Returnee" style="width:18px;height:18px;flex-shrink:0;margin-top:2px;accent-color:var(--navy)"><div style="margin-left:14px"><div style="font-weight:700;color:#1f2937">Returnee</div><p style="font-size:12px;color:#6b7280;margin-top:2px">Previously enrolled at BTECH, returning after a study break</p></div><button type="button" class="bs" style="margin-left:auto;padding:4px 12px;font-size:11px;border-radius:99px" onclick="showReqModal('Returnee')">View requirements</button></label>
      ...
      <div class="sc" data-step="2">
        <div class="fcard">
          <div class="fhdr">
            ...
            <p>As they appear on official government documents</p>
          </div>
          <div class="fbdy">
            <p class="stitle">Student Details</p>
            <div style="display:flex;align-items:center;gap:8px;margin-bottom:16px"><i data-iconsax="alert-circle" style="width:16px;height:16px;color:#10b981"></i>
              <p style="font-size:12px;color:#16a34a;margin:0">In Place Of Birth Only Put Province and City name, not the Specific Address. (ex. Pulilan, Bulacan)</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3" style="margin-top:12px">
              <div>
                ...
                <select name="civilStatus" class="fi">
              ...
              <div><label class="fl">Contact Number <span style="color:var(--red)">*</span></label>
                <div class="phone-wrap"><span class="ppfx">+63</span><input type="tel" name="studentContactNumber" placeholder="9XXXXXXXXX" class="fi phi" maxlength="10"></div><span class="et" id="e-scn"></span>
              </div>
            </div>
            <div style="margin-top:12px">
              <label class="fl">Email Address <span style="color:var(--red)">*</span></label>
              <input type="email" name="studentEmail" placeholder="e.g. juan.delacruz@gmail.com" class="fi">
              <p style="font-size:11px;color:#9aa5b1;margin-top:4px">Only Gmail or Yahoo addresses accepted</p>
              <span class="et" id="e-email"></span>
            </div>
      ...
      <div class="sc" data-step="3">
        <div class="fcard">
          <div class="fhdr">
            ...
            <p>Provide your academic background and credentials</p>
          </div>
          <div class="fbdy">
            <div id="acadElem" class="acad-block">
              <p class="stitle">Elementary School</p>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div><label class="fl">School Name <span style="color:var(--red)">*</span></label><input type="text" name="elemSchool" placeholder="e.g. Baliwag Elementary School" class="fi"></div>
                <div><label class="fl">Year Graduated <span style="color:var(--red)">*</span></label><input type="number" name="elemYear" placeholder="e.g. 2016" class="fi" min="1980" max="2030" step="1" inputmode="numeric"></div>
              </div>
            </div>
            <div id="acadALS" class="acad-block" style="display:none">
              <p class="stitle">ALS (Alternative Learning System)</p>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div><label class="fl">Learning Center Name <span style="color:var(--red)">*</span></label><input type="text" name="alsCenter" placeholder="e.g. Baliwag ALS Center" class="fi"></div>
                <div><label class="fl">Year Completed <span style="color:var(--red)">*</span></label><input type="number" name="alsYear" placeholder="e.g. 2023" class="fi" min="1980" max="2030" step="1" inputmode="numeric"></div>
              </div>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-2">
                <div><label class="fl">A&E Certificate Number <span style="color:var(--red)">*</span></label><input type="text" name="alsCertNo" placeholder="e.g. 123456789" class="fi"></div>
                <div><label class="fl">Test Result/Rating <span style="color:var(--red)">*</span></label><input type="text" name="alsResult" placeholder="e.g. Passed / 90%" class="fi"></div>
              </div>
            </div>
            <div id="acadReturnee" class="acad-block" style="display:none">
              <p class="stitle">BTECH Previous Academic Record</p>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div><label class="fl">Last Program Enrolled <span style="color:var(--red)">*</span></label><input type="text" name="returneeProgram" placeholder="e.g. BSIT" class="fi"></div>
                <div><label class="fl">Last Year Attended <span style="color:var(--red)">*</span></label><input type="number" name="returneeYear" placeholder="e.g. 2022" class="fi" min="1980" max="2030" step="1" inputmode="numeric"></div>
              </div>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-2">
                <div><label class="fl">Student ID Number <span style="color:var(--red)">*</span></label><input type="text" name="returneeID" placeholder="e.g. 2020-12345" class="fi"></div>
                <div><label class="fl">Reason for Return <span style="color:var(--red)">*</span></label><input type="text" name="returneeReason" placeholder="e.g. Academic Leave" class="fi"></div>
              </div>
            </div>
            <div id="acadHS" class="acad-block">
              <p class="stitle">High School</p>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div><label class="fl">School Name <span style="color:var(--red)">*</span></label><input type="text" name="hsSchool" placeholder="e.g. Baliwag High School" class="fi"></div>
                <div><label class="fl">Year Graduated <span style="color:var(--red)">*</span></label><input type="number" name="hsYear" placeholder="e.g. 2020" class="fi" min="1980" max="2030" step="1" inputmode="numeric"></div>
              </div>
            </div>
            <div id="acadSHS" class="acad-block">
              <p class="stitle">Senior High School</p>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div><label class="fl">School Name <span style="color:var(--red)">*</span></label><input type="text" name="shsSchool" placeholder="e.g. Baliwag Senior High" class="fi"></div>
                <div><label class="fl">Year Graduated <span style="color:var(--red)">*</span></label><input type="number" name="shsYear" placeholder="e.g. 2022" class="fi" min="1980" max="2030" step="1" inputmode="numeric"></div>
              </div>
            </div>
            <div id="acadTertiary" class="acad-block" style="display:none">
              <p class="stitle">Tertiary (College/University)</p>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div><label class="fl">School Name <span style="color:var(--red)">*</span></label><input type="text" name="tertiarySchool" placeholder="e.g. Baliwag Polytechnic College" class="fi"></div>
                <div><label class="fl">Year Graduated <span style="color:var(--red)">*</span></label><input type="number" name="tertiaryYear" placeholder="e.g. 2024" class="fi" min="1980" max="2030" step="1" inputmode="numeric"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="sc" data-step="4">
        <div class="fcard">
          <div class="fhdr">
            ...
            <p>Parent/guardian contact numbers</p>
          </div>
          <div class="fbdy">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div><label class="fl">Father's Contact Number <span style="color:var(--red)">*</span></label>
                <div class="phone-wrap"><span class="ppfx">+63</span><input type="tel" name="contactNumber" placeholder="9XXXXXXXXX" class="fi phi" maxlength="10"></div>
                <p style="font-size:11px;color:#9aa5b1;margin-top:4px">10-digit mobile number starting with 9</p><span class="et" id="e-c1"></span>
              </div>
              <div><label class="fl">Mother's Contact Number <span style="color:var(--red)">*</span></label>
                <div class="phone-wrap"><span class="ppfx">+63</span><input type="tel" name="alternateContactNumber" placeholder="9XXXXXXXXX" class="fi phi" maxlength="10"></div>
                <p style="font-size:11px;color:#9aa5b1;margin-top:4px">10-digit mobile number starting with 9</p><span class="et" id="e-c2"></span>
              </div>
            </div>
      ...
      <div class="sc" data-step="5">
        <div class="fcard">
          <div class="fhdr">
            ...
            <p>Your official permanent home address</p>
          </div>
          <div class="fbdy">
      ...
      <div class="sc" data-step="6">
        <div class="fcard">
          <div class="fhdr">
            <h2>Step 6: Present Address</h2>
            <p>Where you are currently residing</p>
          </div>
          <div class="fbdy">
      ...
      <div class="sc" data-step="7">
        <div class="fcard">
          <div class="fhdr">
            <h2>Step 7: Degree Course Selection</h2>
            <p>Your 1st and 2nd choices must be different programs</p>
          </div>
          <div class="fbdy">
      ...
      <div class="sc" data-step="8">
        <div class="fcard">
          <div class="fhdr">
            <h2>Step 8: General Weighted Average</h2>
            <p>Enter your GWA as a percentage score (70-100)</p>
          </div>
          <div class="fbdy">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5" style="max-width:480px">
              <div><label class="fl">Grade 11 GWA <span style="color:var(--red)">*</span></label>
                <div style="position:relative"><input type="number" name="grade11GWA" placeholder="e.g. 88.5" class="fi" min="70" max="100" step="0.01" style="padding-right:48px"><span style="position:absolute;right:12px;top:50%;transform:translateY(-50%);font-size:11px;font-weight:600;color:#9aa5b1">/ 100</span></div><span class="et" id="e-g1"></span>
              </div>
              <div><label class="fl">Grade 12 - 1st Semester GWA <span style="color:var(--red)">*</span></label>
                <div style="position:relative"><input type="number" name="grade12GWA" placeholder="e.g. 90.0" class="fi" min="70" max="100" step="0.01" style="padding-right:48px"><span style="position:absolute;right:12px;top:50%;transform:translateY(-50%);font-size:11px;font-weight:600;color:#9aa5b1">/ 100</span></div><span class="et" id="e-g2"></span>
              </div>
            </div>
      ...
      <div class="sc" data-step="10">
        <div class="fcard">
          <div class="fhdr">
            <h2>Step 10: Declaration &amp; Data Privacy</h2>
            <p>Read and accept all agreements before proceeding</p>
          </div>
          <div class="fbdy">
            <div style="display:flex;flex-direction:column;gap:12px">
              <label class="oc" style="align-items:flex-start"><input type="checkbox" name="declarationTruth" style="width:18px;height:18px;margin-top:2px;accent-color:var(--navy);flex-shrink:0"><span style="margin-left:14px"><span style="font-weight:700;color:#1f2937">I affirm all information provided is true and correct</span>
                  <p style="font-size:12px;color:#6b7280;margin-top:3px">False information may result in disqualification and possible legal consequences.</p>
                </span></label>
              <label class="oc" style="align-items:flex-start"><input type="checkbox" name="dataPrivacy" style="width:18px;height:18px;margin-top:2px;accent-color:var(--navy);flex-shrink:0"><span style="margin-left:14px"><span style="font-weight:700;color:#1f2937">I agree to the processing of my personal data</span>
                  <p style="font-size:12px;color:#6b7280;margin-top:3px">In accordance with the Data Privacy Act of 2012 (Republic Act 10173).</p>
                </span></label>
              <label class="oc" style="align-items:flex-start"><input type="checkbox" name="authorizedProcessing" style="width:18px;height:18px;margin-top:2px;accent-color:var(--navy);flex-shrink:0"><span style="margin-left:14px"><span style="font-weight:700;color:#1f2937">I authorize BTECH to use my data for admission purposes</span>
                  <p style="font-size:12px;color:#6b7280;margin-top:3px">Including communication about my application status and enrollment processes.</p>
                </span></label>
            </div>
      ...
      <div class="sc" data-step="11">
        <div class="fcard">
          <div class="fhdr">
            <h2>Step 11: Upload ID Photo</h2>
            <p>Upload a clear 2x2 ID picture for your application record</p>
          </div>
          <div class="fbdy">
          ...
          <div class="review-sheet" id="reviewSheet">
            ...
            <div class="rs-section">
              ...
              <table class="rs-table">
                <tr>
                  <td class="lbl">Family Name</td>
                  <td class="val" id="rv-surname"></td>
                  <td class="lbl" style="width:120px">First Name</td>
                  <td class="val" id="rv-firstName"></td>
                </tr>
                <tr>
                  <td class="lbl">Middle Name</td>
                  <td class="val" id="rv-middleName"></td>
                  <td class="lbl">Suffix</td>
                  <td class="val" id="rv-suffix"></td>
                </tr>
                <tr>
                  <td class="lbl">Date of Birth</td>
                  <td class="val" id="rv-dob"></td>
                  <td class="lbl">Place of Birth</td>
                  <td class="val" id="rv-pob"></td>
                </tr>
                <tr>
                  <td class="lbl">Sex</td>
                  <td class="val" colspan="3"><span id="rv-male" class="sex-check">&#9744; Male</span><span id="rv-female" class="sex-check">&#9744; Female</span></td>
                </tr>
                <tr>
                  <td class="lbl">Permanent Address</td>
                  <td class="val" colspan="3" id="rv-permAddr"></td>
                </tr>
                <tr>
                  <td class="lbl">Present Address</td>
                  <td class="val" colspan="3" id="rv-presAddr"></td>
                </tr>
              </table>
            </div>
            ...
            <div class="rs-section">
              ...
              <table class="rs-table">
                <tr>
                  <td class="lbl">Mother's Full Name</td>
                  <td class="val" id="rv-motherName"></td>
                  <td class="lbl" style="width:130px">Mother's Contact</td>
                  <td class="val" id="rv-mContact"></td>
                </tr>
                <tr>
                  <td class="lbl">Father's Full Name</td>
                  <td class="val" id="rv-fatherName"></td>
                  <td class="lbl">Father's Contact</td>
                  <td class="val" id="rv-fContact"></td>
                </tr>
              </table>
            </div>
            ...
            <div class="rs-section">
              ...
              <table class="rs-table">
                <tr>
                  <td class="lbl">1st Course Choice</td>
                  <td class="val" id="rv-course1"></td>
                  <td class="lbl" style="width:160px">2nd Course Choice</td>
                  <td class="val" id="rv-course2"></td>
                </tr>
                <tr>
                  <td class="lbl">Grade 11 GWA</td>
                  <td class="val" id="rv-g11"></td>
                  <td class="lbl">Grade 12 GWA (1st Sem)</td>
                  <td class="val" id="rv-g12"></td>
                </tr>
                <tr>
                  <td class="lbl">Average GWA</td>
                  <td class="val" id="rv-gwa" style="font-weight:700"></td>
                  <td class="lbl">Academic Standing</td>
                  <td class="val" id="rv-gwarmk"></td>
                </tr>
              </table>
            </div>
            ...
            <div class="rs-section">
              ...
              <table class="rs-table">
                <tr>
                  <td class="lbl">Applicant Type</td>
                  <td class="val" id="rv-type"></td>
                  <td class="lbl" style="width:200px">Person with Disability (PWD)</td>
                  <td class="val" id="rv-pwd"></td>
                </tr>
                <tr>
                  <td class="lbl">Solo Parent / Child of Solo Parent</td>
                  <td class="val" id="rv-solo"></td>
                  <td class="lbl">4Ps Beneficiary</td>
                  <td class="val" id="rv-4ps"></td>
                </tr>
                <tr>
                  <td class="lbl">Indigenous Person / Tribe Member</td>
                  <td class="val" id="rv-indigenous" colspan="3"></td>
                </tr>
              </table>
            </div>
            ...
            <div class="rs-section">
              ...
              <div class="rs-sig-row">
                <div class="rs-sig-cell">
                  <div class="rs-sig-line"></div>
                  <div class="rs-sig-lbl">Signature over Printed Name of Applicant</div>
                </div>
                <div class="rs-sig-cell">
                  <div class="rs-sig-line"></div>
                  <div class="rs-sig-lbl">Date Signed</div>
                </div>
                <div class="rs-sig-cell">
                  <div class="rs-sig-line"></div>
                  <div class="rs-sig-lbl">Signature of Parent / Guardian</div>
                </div>
              </div>
            </div>
