...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/Inquire-Now.css') }}?v=201">
      ...
      <div class="ac-body">
        ...
        <div class="ac-left-col">
          ...
          <div class="ac-title-wrap">
            <h2 class="ac-title">
              Admissions are<br>currently <span class="closed">closed</span>
            </h2>
        ...
        <div class="ac-right-col">
          ...
          <picture>
            ...
            <img src="{{ asset('assets/images/announcement_logo.png') }}" alt="Students" class="ac-student-img" loading="lazy" decoding="async">
          </picture>
        ...
        <div class="fcard">
          ...
          <div class="fbdy">
            ...
            <label class="oc" style="align-items:center">
              <input type="radio" name="respondentType" value="Freshmen" style="width:18px;height:18px;flex-shrink:0;margin-top:2px;accent-color:var(--navy)">
          ...
          <div class="fbdy">
            ...
            <div class="personal-contact-grid" style="margin-top:12px">
              ...
              <div><label class="fl">Contact Number <span style="color:var(--red)">*</span></label>
                <div class="phone-wrap"><span class="ppfx">+63</span><input type="tel" name="studentContactNumber" placeholder="9XXXXXXXXX" class="fi phi" maxlength="10"></div>
                <p style="font-size:11px;color:#9aa5b1;margin-top:4px">10-digit mobile number starting with 9</p><span class="et" id="e-scn"></span>
              </div>
              <div><label class="fl">Email Address <span style="color:var(--red)">*</span></label><input type="email" name="studentEmail" placeholder="e.g. juan.delacruz@gmail.com" class="fi" title="Only Gmail or Yahoo addresses are accepted">
                <p style="font-size:11px;color:#9aa5b1;margin-top:4px">Only Gmail or Yahoo addresses accepted</p><span class="et" id="e-email"></span>
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
              ...
              <div>
                <label class="fl">Suffix</label>
                <select name="fatherSuffix" class="fi" aria-label="Father's Suffix">
                  <option value="N/A" selected>N/A</option>
                  <option value="Jr.">Jr.</option>
                  <option value="Sr.">Sr.</option>
                  <option value="II">II</option>
